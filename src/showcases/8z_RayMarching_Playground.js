...
import fragmentShaderSource from "../shaders/8z_raymarchingPlayground.glsl";
...
function render(gl, state) {
    ...
    gl.uniform3fv(loc.iTorusCenter, state.iTorusCenter);
    ...
    gl.uniform1f(loc.iLightVelocityFactor, state.iLightVelocityFactor);
    ...
    gl.uniform1f(loc.iSubsurfaceExponent, state.iSubsurfaceExponent);
    gl.uniform1f(loc.iSubsurfaceScattering, state.iSubsurfaceScattering);
...
const uniforms = [{
    separator: "Game Of Life Framerate \u2015 (ist übrigens kein Uniform)"
}, {
    type: "int",
